...
export const Hero = () => {
    ...
    return (
        <>
            <div className=" w-full pt-20  md:max-w-[300px] lg:max-w-[550px]  2xl:max-w-[600px]">
                    <div className="flex flex-col space-y-6">
                        ...
                        <div className=" relative pl-5 p-3 border border-gray-400/80 rounded-4xl">

                            <input id="email" name="email" type="email" 
                                autoComplete="email"
                                placeholder="email" 
                                defaultValue="iwant@findajob.com"
                                className="block outline-0 font-medium text-xs md:text-md text-zinc-800 " />
                            <button type="button" className=" cursor-pointer absolute right-0 -translate-y-1/2 top-1/2 bg-[#135CE7] hover:bg-[#1649b7] px-3 py-3 md:px-6 md:py-3 rounded-full text-white text-xs md:text-[18px] font-semibold">Get Started</button>
                        </div>
